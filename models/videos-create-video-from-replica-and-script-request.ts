 ...
 * 
 * @export
 * @interface VideosCreateVideoFromReplicaAndScriptRequest
 */
export interface VideosCreateVideoFromReplicaAndScriptRequest {
    /**
     ...
     * @type {string}
     * @memberof VideosCreateVideoFromReplicaAndScriptRequest
     */
