 ...
 * 
 * @export
 * @interface VideosGetByVideoIdResponseData
 */
export interface VideosGetByVideoIdResponseData {
    /**
     * The script that was initially used to generate the video.
     * @type {string}
     * @memberof VideosGetByVideoIdResponseData
     */
    'script'?: string;
}
